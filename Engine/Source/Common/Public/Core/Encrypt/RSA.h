...
HLVM_INLINE_VAR const char* HLVM_PRIVATE_KEY_PKCS8 = OBFUSCATED_LONG("-----BEGIN PRIVATE KEY-----\n"
...
{
public:
	HLVM_INLINE_FUNC HLVM_STATIC_FUNC auto PCKS8_Encrypt(const std::span<std::byte>& Buffer)
	{
