# Reference : https://cloud.tencent.com/developer/article/1433431
...
# HLVM - BEGIN
# comment these line out since LIBPROFILER_FOUND is already set by vcpkg,
# but we still need to execute this package finder

#if(LIBPROFILER_FOUND)
#    return()
#endif()

# Not sure what is depcommon but we cannot find this module
#include (depcommon)
# HLVM - END

# linux系统下调用pkg-config查找profiler
if (NOT WIN32 AND NOT LIBPROFILER_PKG_FOUND)
    ...
    set(LIBPROFILER_PKG_FOUND TRUE)
endif()
